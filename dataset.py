...
class RNADataset(torch.utils.data.Dataset):
    def __init__(
        self, df, mode="train", seed=2023, fold=0, nfolds=4, mask_only=False, **kwargs
    ):
        #         self.seq_map = {'A':0,'C':1,'G':2,'U':3}
        self.seq_map = dict(zip(list("ABCDEFGHIJKL"), list(range(12))))
        self.Lmax = 206
        ...
        self.seq = df_2A3["sequence_ext"].values
